...
public class AssignmentList {
    ...
    {
        double sumUp=0.00,sumDown=0.00;
//        for (int i = 0; i < itemList.size(); i++) {
//            sumUp+=(itemList.get(i).getTotalWeight()*)
//        }
        for (Assignment assignment : itemList) {
            
            sumUp += (assignment.getTotalWeight()*assignment.getScore())/assignment.getTotalPoint();
            sumDown += assignment.getTotalWeight();
        }
        return sumUp/sumDown; //TODO Add lines of code in here oioioioioioiooioi
    }
